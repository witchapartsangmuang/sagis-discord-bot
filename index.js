...
const { clearChatMessage } = require('./events/clearChatMessage.js')
...
const { reportCreateChannelButtonInteraction, reportDeleteChannelButtonInteraction } = require('./events/report.js')
...
client.on('messageCreate', async (message) => {
    ...
    if (message.content.startsWith('cls')) {
        clearChatMessage(client, message)
    }
...
client.on('interactionCreate', async (interaction) => {
    if (interaction.isButton) {
        ...
        if (interaction.customId === 'reportCreateChannelButton') {
            reportCreateChannelButtonInteraction(interaction)
        }
        if (interaction.customId === 'reportDeleteChannelButton') {
            reportDeleteChannelButtonInteraction(interaction)
        }
